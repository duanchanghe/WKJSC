 ...
 *  设置全局的日志等级
 *
 *  levelString UMSocialLogClosedString,UMSocialLogErrorString,UMSocialLogWarnString,UMSocialLogInfoString,UMSocialLogDebugString,UMSocialLogVerboseString
 ...
 *  根据等级打印日志
 *
 *  @param flagString  below  UMSocialLogClosedFlagString...and so on
 *  @param file        打印日志的文件
